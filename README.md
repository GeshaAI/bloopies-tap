...
4. The workflow installs Java 17, Godot **4.4.1**, matching export templates, creates an ephemeral standard debug keystore, performs a headless import, and exports the package `com.bloopiesworld.bloopiestap`.
...
The keystore is generated only for debug builds in CI. Production Play Store publishing should use an encrypted repository secret and a permanent release key.
